...
export interface QueryResultInfinite<TResult, TVariables> extends QueryResult<TResult, TVariables> {
...
export interface QueryCache<TResult, TVariables extends object, TCache> {
  ...
  refetchQueries: (
    queryKeyOrPredicateFn: QueryKey<TVariables> | ((query: QueryObject) => boolean),
    config: {
      exact?: boolean;
      throwOnError?: boolean;
      force?: boolean;

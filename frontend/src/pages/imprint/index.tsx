...
const ImprintPage: React.FC<ImprintPageProps> = () => {
  return (
    <div>
      <h1 className="text-lg font-bold mb-2">Impressum</h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Vertreten durch: <br />
        Benjamin von Polheim <br />
        Vanessa von Polheim <br />
        Maro Rudolf <br />
        Frédéric Bolvin <br />
        Matthäus Dubiel <br />
      </p>
      ...
      <p className="mb-12">
        <h2>Kontakt</h2>
        E-Mail: ben[at]vp.solutions <br />
      </p>

      <h2 className="text-md font-bold mb-4 underline">Haftungsausschluss</h2>

      <h2 className="text-md font-bold mb-2">Haftung für Inhalte</h2>
      <p className="mb-6">
      ...
      <h2 className="text-md font-bold mb-2">Haftung für Links</h2>
      <p className="mb-6">
      ...
      <h2 className="text-md font-bold mb-2">Urheberrecht</h2>
      <p className="mb-6">
      ...
      <h2 className="text-md font-bold mb-2">Datenschutz</h2>
      <p className="mb-6">
      ...
      <h2 className="text-md font-bold mb-2">Google Analytics</h2>
      <p className="mb-6">
      ...
      <h2 className="text-md font-bold mb-2">Google AdSense</h2>
      <p className="mb-6">

            ...
            <div
              className={
                menuOpen
                  ...
                  : 'absolute top-0 inset-x-0 p-2 transition transform origin-top-right hidden'
              }
            >
              <div className="rounded-lg shadow-md">
                <div className="rounded-lg bg-white shadow-xs overflow-hidden">
                  ...
                  <div className="px-2 pt-2 pb-3">
                    ...
                    <Link href={ROUTES.SIGN_UP}>
                      <a className="mt-1 block text-indigo-700 px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out">
                        Jetzt mitmachen
                      </a>
                    </Link>
                  </div>
            ...
            <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Gemeinsam daheim fit bleiben - auch in Quarantäne.
                </p>
            ...
            <ul className="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                ...
                <div className="flex">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white p-2">
                      <img src="/img/landing/benefit-1-w.svg" />
                    </div>
                  </div>
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-base leading-6 text-gray-500">
                      Erstelle dein Training oder schließe Dich einem Training an. Lade Freunde ein
                      oder finde neue Trainingspartner*innen. Motiviert euch gegenseitig!
                    </p>
                  </div>
                </div>
              </li>
              ...
              <li className="mt-10 md:mt-0">
                <div className="flex">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white p-2">
                      <img src="/img/landing/benefit-3-w.svg" />
                    </div>
                  </div>
                  <div className="ml-4">
                    <h5 className="text-lg leading-6 font-medium text-gray-900">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-base leading-6 text-gray-500">
                      ...
                      vor dem finanziellen Ruin. Unterstütze deine Trainer mit einer Spenden und sei
                      behilflich in dieser schweren Zeit.
                    </p>
                  </div>
                </div>
              </li>
